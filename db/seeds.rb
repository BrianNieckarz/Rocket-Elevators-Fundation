...
User.create(first_name: 'Timothy', last_name: 'Wever', email: 'timothy.wever@codeboxx.biz', password: "tk1234", password_confirmation: "tk1234")
Employee.create(title: "Developer", user_id: 7)
User.create(first_name: 'Kiril', last_name: 'Kleinerman', email: 'kiril.kleinerman@codeboxx.biz', password: "kd1234", password_confirmation: "kd1234")
Employee.create(title: "Developer", user_id: 8)
User.create(first_name: 'Emmanuela', last_name: 'Derilus', email: 'emmanuela.derilus@codeboxx.biz', password: "ed1234", password_confirmation: "ed1234")
...
User.create(first_name: 'Perry', last_name: 'Sawatzky', email: 'perry.sawatzky@codeboxx.biz', password: "ps1234", password_confirmation: "ps1234")
...
(1..3).each do |i|
    Intervention.create!(author: "Perry", battery_id: "10", column_id: "4", elevator_id: "29", employee_id: "23", status: "pending", report: "Hello! I'm awesome")
end